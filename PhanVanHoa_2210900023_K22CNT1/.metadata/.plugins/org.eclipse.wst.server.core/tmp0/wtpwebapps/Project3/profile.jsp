...
<body>
	...
	<div class="container">
        <!-- Sidebar -->
        <div class="sidebar">
            <div class="logo">Người dùng</div>
            <ul>
                <li><a href="#"><i class="fas fa-user me-2"></i> Thông tin cá nhân</a></li>
                <li><a href="#"><i class="fas fa-money-bill-wave me-2"></i> Chi tiêu cá nhân</a></li>
                <li><a href="#"><i class="fas fa-wallet me-2"></i> Ngân sách</a></li>
                <li><a href="#"><i class="fas fa-exchange-alt me-2"></i> Giao dịch</a></li>
                <li><a href="#"><i class="fas fa-sync-alt me-2"></i> Giao dịch định kỳ</a></li>
                <li><a href="#"><i class="fas fa-piggy-bank me-2"></i> Tiết kiệm</a></li>
